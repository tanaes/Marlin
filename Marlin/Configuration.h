...
#define STRING_CONFIG_H_AUTHOR "Jon Sanders" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Artillery Genius BMG"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 33, -44, 0 }
